  ...
  return (
    <div className='container text-center mt-5'>
        ...
        <form className='w-full'>
         <input type='text' placeholder='Subject' value={subject} onChange={handleChange} className='input input-bordered input-md w-full  mt-3' />
         <br></br>
         <textarea value={message} onChange={onChange} className='textarea textarea-primary mt-3 w-full' ></textarea>
